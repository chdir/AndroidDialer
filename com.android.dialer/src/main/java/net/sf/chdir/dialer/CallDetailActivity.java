...
import net.sf.chdir.dialer.calllog.CallDetailHistoryAdapter;
import net.sf.chdir.dialer.calllog.CallLogAsyncTaskUtil;
import net.sf.chdir.dialer.calllog.CallLogAsyncTaskUtil.CallLogAsyncTaskListener;
import net.sf.chdir.dialer.calllog.CallTypeHelper;
import net.sf.chdir.dialer.calllog.ContactInfoHelper;
import net.sf.chdir.dialer.calllog.PhoneAccountUtils;
import net.sf.chdir.dialer.compat.FilteredNumberCompat;
...
import net.sf.chdir.dialer.filterednumber.FilteredNumbersUtil;
import net.sf.chdir.dialer.logging.InteractionEvent;
...
import net.sf.chdir.dialer.util.PhoneNumberUtil;
import net.sf.chdir.dialer.util.TelecomUtil;
import net.sf.chdir.incallui.Call.LogState;
