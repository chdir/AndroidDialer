...
import net.sf.chdir.dialer.util.EmptyLoader;
import net.sf.chdir.dialer.voicemail.VoicemailPlaybackPresenter;
import net.sf.chdir.dialer.widget.EmptyContentView;
import net.sf.chdir.dialer.widget.EmptyContentView.OnEmptyViewActionButtonClickedListener;
