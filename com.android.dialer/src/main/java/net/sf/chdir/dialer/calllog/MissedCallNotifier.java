...
import net.sf.chdir.dialer.calllog.CallLogNotificationsHelper.NewCall;
import net.sf.chdir.dialer.contactinfo.ContactPhotoLoader;
import net.sf.chdir.dialer.compat.UserManagerCompat;
