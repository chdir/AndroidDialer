...
package net.sf.chdir.dialer.compat;
...
import net.sf.chdir.dialer.DialerApplication;
import net.sf.chdir.dialer.database.FilteredNumberAsyncQueryHandler;
import net.sf.chdir.dialer.database.FilteredNumberAsyncQueryHandler.OnCheckBlockedListener;
import net.sf.chdir.dialer.database.FilteredNumberContract.FilteredNumber;
import net.sf.chdir.dialer.database.FilteredNumberContract.FilteredNumberColumns;
import net.sf.chdir.dialer.database.FilteredNumberContract.FilteredNumberSources;
import net.sf.chdir.dialer.database.FilteredNumberContract.FilteredNumberTypes;
import net.sf.chdir.dialer.filterednumber.BlockNumberDialogFragment;
import net.sf.chdir.dialer.filterednumber.BlockNumberDialogFragment.Callback;
import net.sf.chdir.dialer.filterednumber.BlockedNumbersMigrator;
import net.sf.chdir.dialer.filterednumber.BlockedNumbersSettingsActivity;
import net.sf.chdir.dialer.filterednumber.MigrateBlockedNumbersDialogFragment;
 ...
 * {@link net.sf.chdir.dialer.database.FilteredNumberContract} and using
