...
package net.sf.chdir.dialer.calllog;
...
import net.sf.chdir.dialer.DialtactsActivity;
import net.sf.chdir.dialer.PhoneCallDetails;
import net.sf.chdir.dialer.R;
import net.sf.chdir.dialer.calllog.calllogcache.CallLogCache;
import net.sf.chdir.dialer.contactinfo.ContactInfoCache;
import net.sf.chdir.dialer.contactinfo.ContactInfoCache.OnContactInfoChangedListener;
import net.sf.chdir.dialer.database.FilteredNumberAsyncQueryHandler;
import net.sf.chdir.dialer.database.VoicemailArchiveContract;
...
public class CallLogAdapter extends GroupingListAdapter
     ...
     *  put into the primary call groups in {@link net.sf.chdir.dialer.calllog.CallLogGroupBuilder},
     ...
     * populated in {@link net.sf.chdir.dialer.calllog.CallLogGroupBuilder}.
     *
