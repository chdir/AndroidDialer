...
package net.sf.chdir.dialer.database;
...
import net.sf.chdir.dialer.database.VoicemailArchiveContract.VoicemailArchive;
...
public class DialerDatabaseHelper extends SQLiteOpenHelper {
     ...
     */
    private static final String DATABASE_LAST_CREATED_SHARED_PREF = "net.sf.chdir.dialer";
    ...
    public static final Uri SMART_DIAL_UPDATED_URI =
            Uri.parse("content://net.sf.chdir.dialer/smart_dial_updated");
